...
import com.kk.domain.entity.DO.OrderDOExample.Criteria;
import com.kk.domain.entity.DO.OrderDOExample.Criterion;
...
public class OrderDOSqlProvider {
    ...
    public String insertSelective(OrderDO record) {
        ...
        if (record.getPayAmount() != null) {
            sql.VALUES("pay_amount", "#{payAmount,jdbcType=BIGINT}");
        }
    ...
    protected void applyWhere(SQL sql, OrderDOExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
